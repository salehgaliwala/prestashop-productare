...
<div id="pap-translations">

	<div id="form-pap-translations" class="form-wrapper pap-form-wrapper" style="padding-left: 15px;">
		<h3>{l s='Translations' mod='productareapacks'}</h3>
